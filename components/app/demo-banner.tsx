...
export function DemoBanner({ persona }: { persona: DemoPersona }) {
  return (
    <div data-demo-banner className="border-b border-amber-500/30 bg-amber-500/10">
      <div className="mx-auto flex max-w-2xl flex-wrap items-center gap-x-3 gap-y-1.5 px-4 py-2 text-xs">
        <span className="inline-flex items-center gap-1.5 font-medium text-amber-800 dark:text-amber-400">
